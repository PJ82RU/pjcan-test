...
;// CONCATENATED MODULE: ./src/layout/BaseLayout.vue?vue&type=template&id=1b751223&scoped=true&ts=true
...
/* harmony default export */ var BaseLayoutvue_type_script_lang_ts = ({
  ...
  setup() {
    ...
    const title = (0,runtime_core_esm_bundler/* computed */.EW)(() => {
      ...
      return "PJCAN 4.1: " + (result?.length > 0 ? t(result) : "");
    });
...
const __exports__ = /*#__PURE__*/(0,exportHelper/* default */.A)(BaseLayoutvue_type_script_lang_ts, [['render',render],['__scopeId',"data-v-1b751223"]])
