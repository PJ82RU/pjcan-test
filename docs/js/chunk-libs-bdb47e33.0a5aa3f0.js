...
/* harmony export */   Kx: function() { return /* binding */ CompileErrorCodes; },
...
/* harmony export */   sL: function() { return /* binding */ CompileWarnCodes; }
/* harmony export */ });
/* unused harmony exports ERROR_DOMAIN, LOCATION_STUB, createCompileWarn, createLocation, createParser, createPosition, detectHtmlTag, errorMessages, warnMessages */
...
/* harmony export */   ID: function() { return /* binding */ CoreWarnCodes; },
...
/* harmony export */   a9: function() { return /* binding */ CoreErrorCodes; },
...
/* harmony export */   fw: function() { return /* binding */ compileToFunction; },
...
/* harmony import */ var _intlify_message_compiler__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(56751);
...
function initFeatureFlags() {
  ...
  if (typeof __INTLIFY_JIT_COMPILATION__ !== 'boolean') {
    (0,_intlify_shared__WEBPACK_IMPORTED_MODULE_8__/* .getGlobalThis */ .We)().__INTLIFY_JIT_COMPILATION__ = false;
  }
...
function createMessageContext(options = {}) {
  ...
  function message(key) {
    // prettier-ignore
    const msg = (0,_intlify_shared__WEBPACK_IMPORTED_MODULE_8__/* .isFunction */ .Tn)(options.messages) ? options.messages(key) : (0,_intlify_shared__WEBPACK_IMPORTED_MODULE_8__/* .isObject */ .Gv)(options.messages) ? options.messages[key] : false;
...
const code$1 = _intlify_message_compiler__WEBPACK_IMPORTED_MODULE_9__/* .CompileWarnCodes */ .sL.__EXTEND_POINT__;
const inc$1 = (0,_intlify_shared__WEBPACK_IMPORTED_MODULE_8__/* .incrementer */ .Je)(code$1);
const CoreWarnCodes = {
...
const code = _intlify_message_compiler__WEBPACK_IMPORTED_MODULE_9__/* .CompileErrorCodes */ .Kx.__EXTEND_POINT__;
const inc = (0,_intlify_shared__WEBPACK_IMPORTED_MODULE_8__/* .incrementer */ .Je)(code);
...
const compileToFunction = (message, context) => {
  if (!(0,_intlify_shared__WEBPACK_IMPORTED_MODULE_8__/* .isString */ .Kg)(message)) {
...
function compile(message, context) {
  // set onWarn
  if (false) {}
  if (__INTLIFY_JIT_COMPILATION__ && !__INTLIFY_DROP_MESSAGE_COMPILER__ && (0,_intlify_shared__WEBPACK_IMPORTED_MODULE_8__/* .isString */ .Kg)(message)) {
    // check HTML message
    const warnHtmlMessage = (0,_intlify_shared__WEBPACK_IMPORTED_MODULE_8__/* .isBoolean */ .Lm)(context.warnHtmlMessage) ? context.warnHtmlMessage : true;
     false && 0;
    // check caches
...
/* harmony export */   Je: function() { return /* binding */ incrementer; },
