  ...
  return (0,runtime_core_esm_bundler/* openBlock */.uX)(), (0,runtime_core_esm_bundler/* createBlock */.Wv)(VApp/* VApp */.E, {
    ...
    default: (0,runtime_core_esm_bundler/* withCtx */.k6)(() => [(0,runtime_core_esm_bundler/* createVNode */.bF)(VAppBar/* VAppBar */.z, {
      ...
      default: (0,runtime_core_esm_bundler/* withCtx */.k6)(() => [(0,runtime_core_esm_bundler/* createVNode */.bF)(VToolbarTitle/* VToolbarTitle */.s, null, {
        ...
        _: 1
      }), (0,runtime_core_esm_bundler/* createVNode */.bF)(VSpacer/* VSpacer */.h), _ctx.$vuetify.display.mdAndUp ? ((0,runtime_core_esm_bundler/* openBlock */.uX)(), (0,runtime_core_esm_bundler/* createBlock */.Wv)(VBtn/* VBtn */.D, {
        key: 0,
...
var BluetoothBtn = __webpack_require__(36164);
// EXTERNAL MODULE: ./src/components/dialogs/UpdateFirmwareDialog.vue + 4 modules
var UpdateFirmwareDialog = __webpack_require__(88920);
...
var LocaleDialog = __webpack_require__(41226);
  ...
  setup() {
    ...
    const onNewVersion = newVersion => {
      ...
      if (version.supported) {
        setTimeout(() => {
          esm/* toast */.oR.warning(t("update.notify.newVersion", {
            version: newVersionFirmware.value
          }));
        }, 5000);
...
const __exports__ = /*#__PURE__*/(0,exportHelper/* default */.A)(BaseLayoutvue_type_script_lang_ts, [['render',render],['__scopeId',"data-v-9bdfd618"]])
