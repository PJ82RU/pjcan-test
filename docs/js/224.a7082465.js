...
// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  "default": function() { return /* binding */ views_buttons; }
});
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  const _component_button_edit_dialog = (0,runtime_core_esm_bundler/* resolveComponent */.E1)("button-edit-dialog");
  return (0,runtime_core_esm_bundler/* openBlock */.Wz)(), (0,runtime_core_esm_bundler/* createElementBlock */.An)(runtime_core_esm_bundler/* Fragment */.ae, null, [$setup.configLoaded ? ((0,runtime_core_esm_bundler/* openBlock */.Wz)(), (0,runtime_core_esm_bundler/* createBlock */.Az)(_component_flicking, {
    key: 0,
    ref: "flicking",
    class: "listSW1",
    options: {
    ...
    default: (0,runtime_core_esm_bundler/* withCtx */.Ql)(() => [((0,runtime_core_esm_bundler/* openBlock */.Wz)(true), (0,runtime_core_esm_bundler/* createElementBlock */.An)(runtime_core_esm_bundler/* Fragment */.ae, null, (0,runtime_core_esm_bundler/* renderList */.mi)($setup.listWithoutEmpty, (item, index) => {
      ...
      }, [(0,runtime_core_esm_bundler/* createVNode */.K2)(_component_settings_card, {
        class: (0,shared_esm_bundler/* normalizeClass */.WN)(`settings-card-${index}`),
        title: item.title,
        icon: item.icon,
        config: item.config,
        mode: $setup.isMode,
    ...
    _: 1
  }, 512)) : (0,runtime_core_esm_bundler/* createCommentVNode */.g1)("", true), (0,runtime_core_esm_bundler/* createVNode */.K2)(_component_button_definition_dialog, {
  ...
  }, null, 8, ["modelValue", "types", "value-id", "value-resistance", "onClick:apply"]), (0,runtime_core_esm_bundler/* createVNode */.K2)(_component_button_edit_dialog, {
...
const _withScopeId = n => (_pushScopeId("data-v-1fe52604"), n = n(), _popScopeId(), n);
const _hoisted_1 = {
  ...
  return (0,runtime_core_esm_bundler/* openBlock */.Wz)(), (0,runtime_core_esm_bundler/* createBlock */.Az)(_component_card, {
    ...
    body: (0,runtime_core_esm_bundler/* withCtx */.Ql)(() => [(0,runtime_core_esm_bundler/* createVNode */.K2)(VRow/* VRow */.s, null, {
      default: (0,runtime_core_esm_bundler/* withCtx */.Ql)(() => [(0,runtime_core_esm_bundler/* createVNode */.K2)(VCol/* VCol */.m, {
        ...
        default: (0,runtime_core_esm_bundler/* withCtx */.Ql)(() => [(0,runtime_core_esm_bundler/* createElementVNode */.QD)("span", _hoisted_1, (0,shared_esm_bundler/* toDisplayString */.WA)(_ctx.$t("buttons.extendedMode")), 1)]),
        _: 1
      }), (0,runtime_core_esm_bundler/* createVNode */.K2)(VCol/* VCol */.m, {
        cols: "12",
        class: "pt-0"
...
/* harmony default export */ var SettingsCardvue_type_script_lang_ts = ({
  ...
  setup(props, {
    ...
    const __config = (0,reactivity_esm_bundler/* ref */.IL)({});
    const copyConfig = () => {
      __config.value = {
    ...
    (0,runtime_core_esm_bundler/* watch */.Kg)(config, () => copyConfig());
    /** Расширенный функционал кнопок */
    const extended = (0,runtime_core_esm_bundler/* computed */.S6)({
    ...
    const hold = (0,runtime_core_esm_bundler/* computed */.S6)({
    ...
    const resistanceMin = (0,runtime_core_esm_bundler/* computed */.S6)(() => __config.value?.resistanceMin ?? 0);
    /** Максимальное сопротивление кнопки */
    const resistanceMax = (0,runtime_core_esm_bundler/* computed */.S6)(() => __config.value?.resistanceMax ?? 0);
    /** Кнопка нажата один раз */
    const pressSingle = (0,runtime_core_esm_bundler/* computed */.S6)({
      get: () => __config.value?.exec?.[buttons/* TButtonType */.zA.PRESS_SINGLE] ?? 0,
      set: val => {
        if (config.value) {
          __config.value.exec[buttons/* TButtonType */.zA.PRESS_SINGLE] = val;
          emit("update", __config.value);
        }
      }
    });
    /** Кнопка нажата два раза */
    const pressDual = (0,runtime_core_esm_bundler/* computed */.S6)({
      get: () => __config.value?.exec?.[buttons/* TButtonType */.zA.PRESS_DUAL] ?? 0,
      set: val => {
        if (config.value) {
          __config.value.exec[buttons/* TButtonType */.zA.PRESS_DUAL] = val;
          emit("update", __config.value);
        }
      }
    });
    /** Кнопка нажата три раза */
    const pressTriple = (0,runtime_core_esm_bundler/* computed */.S6)({
      get: () => __config.value?.exec?.[buttons/* TButtonType */.zA.PRESS_TRIPLE] ?? 0,
      set: val => {
        if (config.value) {
          __config.value.exec[buttons/* TButtonType */.zA.PRESS_TRIPLE] = val;
          emit("update", __config.value);
        }
      }
    });
    /** Удержание кнопки */
    const pressHold = (0,runtime_core_esm_bundler/* computed */.S6)({
      get: () => __config.value?.exec?.[buttons/* TButtonType */.zA.PRESS_HOLD] ?? 0,
      set: val => {
        if (config.value) {
          __config.value.exec[buttons/* TButtonType */.zA.PRESS_HOLD] = val;
          emit("update", __config.value);
        }
      }
    });
    /** Кнопка нажата один раз в режиме Mode */
    const modePressSingle = (0,runtime_core_esm_bundler/* computed */.S6)({
      get: () => __config.value?.execMode?.[buttons/* TButtonType */.zA.PRESS_SINGLE] ?? 0,
      set: val => {
        if (config.value) {
          __config.value.execMode[buttons/* TButtonType */.zA.PRESS_SINGLE] = val;
          emit("update", __config.value);
        }
      }
    });
    /** Кнопка нажата два раза в режиме Mode */
    const modePressDual = (0,runtime_core_esm_bundler/* computed */.S6)({
      get: () => __config.value?.execMode?.[buttons/* TButtonType */.zA.PRESS_DUAL] ?? 0,
      set: val => {
        if (config.value) {
          __config.value.execMode[buttons/* TButtonType */.zA.PRESS_DUAL] = val;
          emit("update", __config.value);
        }
      }
    });
    /** Кнопка нажата три раза в режиме Mode */
    const modePressTriple = (0,runtime_core_esm_bundler/* computed */.S6)({
      get: () => __config.value?.execMode?.[buttons/* TButtonType */.zA.PRESS_TRIPLE] ?? 0,
      set: val => {
        if (config.value) {
          __config.value.execMode[buttons/* TButtonType */.zA.PRESS_TRIPLE] = val;
          emit("update", __config.value);
        }
      }
    });
    /** Удержание кнопки в режиме Mode */
    const modePressHold = (0,runtime_core_esm_bundler/* computed */.S6)({
      get: () => __config.value?.execMode?.[buttons/* TButtonType */.zA.PRESS_HOLD] ?? 0,
      set: val => {
        if (config.value) {
          __config.value.execMode[buttons/* TButtonType */.zA.PRESS_HOLD] = val;
          emit("update", __config.value);
        }
      }
    });
...
const __exports__ = /*#__PURE__*/(0,exportHelper/* default */.c)(SettingsCardvue_type_script_lang_ts, [['render',SettingsCardvue_type_template_id_1fe52604_scoped_true_ts_true_render],['__scopeId',"data-v-1fe52604"]])

/* harmony default export */ var SettingsCard = (__exports__);
// EXTERNAL MODULE: ./node_modules/vuetify/lib/components/VBtn/VBtn.mjs + 2 modules
var VBtn = __webpack_require__(4448);
;// CONCATENATED MODULE: ./node_modules/webpack-plugin-vuetify/dist/scriptLoader.js!./node_modules/thread-loader/dist/cjs.js!./node_modules/babel-loader/lib/index.js!./node_modules/ts-loader/index.js??clonedRuleSet-41.use[2]!./node_modules/vue-loader/dist/templateLoader.js??ruleSet[1].rules[5]!./node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./src/views/buttons/components/ButtonDefinitionDialog.vue?vue&type=template&id=268d9a5a&scoped=true&ts=true

function ButtonDefinitionDialogvue_type_template_id_268d9a5a_scoped_true_ts_true_render(_ctx, _cache, $props, $setup, $data, $options) {
  const _component_number_field = (0,runtime_core_esm_bundler/* resolveComponent */.E1)("number-field");
...
/* harmony default export */ var ButtonDefinitionDialogvue_type_script_lang_ts = ({
  ...
  setup(props, {
    ...
    const id = (0,reactivity_esm_bundler/* ref */.IL)(undefined);
    const resistanceMin = (0,reactivity_esm_bundler/* ref */.IL)(0);
    const resistanceMax = (0,reactivity_esm_bundler/* ref */.IL)(0);
    const disabled = (0,runtime_core_esm_bundler/* computed */.S6)(() => id.value === undefined);
...
;// CONCATENATED MODULE: ./src/views/buttons/components/ButtonDefinitionDialog.vue?vue&type=style&index=0&id=268d9a5a&lang=scss&scoped=true
...
const ButtonDefinitionDialog_exports_ = /*#__PURE__*/(0,exportHelper/* default */.c)(ButtonDefinitionDialogvue_type_script_lang_ts, [['render',ButtonDefinitionDialogvue_type_template_id_268d9a5a_scoped_true_ts_true_render],['__scopeId',"data-v-268d9a5a"]])
...
/* harmony default export */ var ButtonEditDialogvue_type_script_lang_ts = ({
  ...
  setup(props, {
    ...
    const modelName = (0,reactivity_esm_bundler/* ref */.IL)("");
    const modelPress = (0,reactivity_esm_bundler/* ref */.IL)(buttons/* TButtonExec */.MT.BUTTON_EXEC_NONE);
    const modelResistanceMin = (0,reactivity_esm_bundler/* ref */.IL)(0);
    const modelResistanceMax = (0,reactivity_esm_bundler/* ref */.IL)(0);
    const disabled = (0,runtime_core_esm_bundler/* computed */.S6)(() => !(modelName.value?.length > 0 && modelPress.value > 0 && modelResistanceMin.value < modelResistanceMax.value));
...
;
const ButtonEditDialog_exports_ = /*#__PURE__*/(0,exportHelper/* default */.c)(ButtonEditDialogvue_type_script_lang_ts, [['render',ButtonEditDialogvue_type_template_id_5d8a23c3_ts_true_render]])
...
/* harmony default export */ var buttonsvue_type_script_lang_ts = ({
  ...
  setup() {
    ...
    const __type = (0,runtime_core_esm_bundler/* computed */.S6)(() => router["default"].currentRoute.value.query?.type);
    const __getKey = type => {
      switch (type) {
        case "sw1":
          return {
    ...
    const keys = (0,runtime_core_esm_bundler/* computed */.S6)(() => __getKey(__type.value));
    const configLoaded = (0,runtime_core_esm_bundler/* computed */.S6)(() => keys.value && store/* default */.c.getters[keys.value.config].isData);
    const value = (0,runtime_core_esm_bundler/* computed */.S6)(() => keys.value ? store/* default */.c.getters[keys.value.value] : undefined);
    const isMode = (0,runtime_core_esm_bundler/* computed */.S6)(() => {
      return keys.value && (store/* default */.c.getters[keys.value.config].items?.filter(x => x.extended)?.findIndex(x => x.exec.findIndex(y => y === buttons/* TButtonExec */.MT.BUTTON_EXEC_ENTERING_MODE) >= 0) >= 0 ?? false);
    });
    const list = (0,reactivity_esm_bundler/* ref */.IL)([]);
    const listWithoutEmpty = (0,runtime_core_esm_bundler/* computed */.S6)(() => list.value?.filter(x => x.title?.length));
    const definitionDialog = (0,reactivity_esm_bundler/* ref */.IL)(false);
    const addDialog = (0,reactivity_esm_bundler/* ref */.IL)(false);
    const selectedItem = (0,reactivity_esm_bundler/* ref */.IL)(undefined);
    /** Загрузка списка кнопок */
    const loadButtons = type => {
      const key = __getKey(type);
      if (key) {
        store/* default */.c.dispatch(key.read);
        list.value = store/* default */.c.getters[key.config].items.map(config => ({
          ...(store/* default */.c.getters[key.app]?.find(x => x.id === config.id) ?? {
            id: config.id,
            title: "",
            icon: ""
          }),
    ...
    const saveButtons = () => {
      if (keys.value) {
        store/* default */.c.commit(keys.value.set, list.value);
        store/* default */.c.dispatch(keys.value.write);
      }
    };
    /** Изменение значений конфигурации кнопок */
    const onButtonConfigUpdate = item => {
      if (keys.value) store/* default */.c.commit(keys.value.setItem, item);
    };
    /**
    ...
    const onButtonDefinitionApply = (id, min, max) => {
      if (id && keys.value) store/* default */.c.commit(keys.value?.setResistance, {
        id,
        min,
        max
      });
    ...
    const onButtonsValueReceive = () => {
      if (keys.value) {
        const res = store/* default */.c.getters[keys.value.value];
        if (res.isData) {
    ...
    const onBegin = type => {
      ...
      if (key) {
        canbus/* default */.c.addListener(buttons/* API_BUTTON_SW1_VALUE_EVENT */.E$, onButtonsValueReceive);
        store/* default */.c.commit(key.setProgramming, true);
      }
    };
    const onEnd = () => {
      canbus/* default */.c.removeListener(buttons/* API_BUTTON_SW1_VALUE_EVENT */.E$, onButtonsValueReceive);
      store/* default */.c.commit("config/setSW1Programming", false);
    };
    (0,runtime_core_esm_bundler/* watch */.Kg)(configLoaded, () => onBegin(__type.value));
    (0,runtime_core_esm_bundler/* watch */.Kg)(__type, val => {
      if (val.name === "Buttons") {
        onEnd();
        onBegin(val);
      }
...
const buttons_exports_ = /*#__PURE__*/(0,exportHelper/* default */.c)(buttonsvue_type_script_lang_ts, [['render',render],['__scopeId',"data-v-4a520ec8"]])
