    ...
    const onConnected = status => {
      ...
      switch (status) {
        case bluetooth/* TConnectedStatus */.s5.NO_CONNECT:
          esm/* toast */.oR.error(t("BLE.notify.noConnected"));
          break;
        case bluetooth/* TConnectedStatus */.s5.CONNECT:
          esm/* toast */.oR.success(t("BLE.notify.connected"));
          break;
        case bluetooth/* TConnectedStatus */.s5.WAIT_CONNECT:
          esm/* toast */.oR.error(t("BLE.notify.lostConnected"));
          break;
        case bluetooth/* TConnectedStatus */.s5.DISCONNECT:
          esm/* toast */.oR.warning(t("BLE.notify.disconnected"));
          break;
      }
    };
    /** Событие отправки данных */
    const onSend = () => esm/* toast */.oR.error(t("BLE.notify.noData"));
...
var MenuDots = __webpack_require__(67664);
...
const __exports__ = /*#__PURE__*/(0,exportHelper/* default */.A)(Cardvue_type_script_lang_ts, [['render',render],['__scopeId',"data-v-3356237f"]])
...
const __exports__ = /*#__PURE__*/(0,exportHelper/* default */.A)(IconCardItemvue_type_script_lang_ts, [['render',render],['__scopeId',"data-v-3c43b4e3"]])
...
const __exports__ = /*#__PURE__*/(0,exportHelper/* default */.A)(InputCardItemvue_type_script_lang_ts, [['render',render],['__scopeId',"data-v-1c427f86"]])
...
/* harmony default export */ var DeviceResetDialogvue_type_script_lang_ts = ({
  ...
  setup(props, context) {
    ...
    /** Применить */
    const onApply = () => {
      canbus/* default */.A.rebootDevice(!resetConfig.value && !resetView.value, resetConfig.value, resetView.value);
      visible.value = false;
    };
    return {
      visible,
...
;
const __exports__ = /*#__PURE__*/(0,exportHelper/* default */.A)(DeviceResetDialogvue_type_script_lang_ts, [['render',DeviceResetDialogvue_type_template_id_520db326_ts_true_render]])
...
function Scannervue_type_template_id_45601db1_ts_true_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return (0,runtime_core_esm_bundler/* openBlock */.uX)(), (0,runtime_core_esm_bundler/* createBlock */.Wv)(_component_dialog_template, {
    ...
    body: (0,runtime_core_esm_bundler/* withCtx */.k6)(() => [(0,runtime_core_esm_bundler/* createElementVNode */.Lk)("div", null, (0,shared_esm_bundler/* toDisplayString */.v_)(_ctx.$t("scanner.upload.text")), 1), (0,runtime_core_esm_bundler/* createElementVNode */.Lk)("div", _hoisted_1, (0,shared_esm_bundler/* toDisplayString */.v_)(_ctx.$t("scanner.upload.leftToLoad", {
  ...
  setup(props, {
    ...
    (0,runtime_core_esm_bundler/* watch */.wB)(started, val => {
      if (!canbus/* default */.A.scanner(val, success => {
        if (val && success) {
          // запускаем диалог
          scanClose = false;
          store/* default */.A.commit("app/clearMessages");
          steps();
        }
      })) {
        esm/* toast */.oR.error(t("scanner.notify.errorStart"));
      }
    });
    /**
     * Шаги
    ...
    const steps = (index = 0) => {
      ...
      if (index < 4) {
        ...
        message.btns?.push({
          ...
          on: () => {
            started.value = false;
            if (leftUploading.value) setTimeout(() => visibleUploading.value = true, 400);else esm/* toast */.oR.warning(t("scanner.notify.warningSend"));
          }
        });
      }
    ...
    const sendScannerBuffer = () => {
      ...
      if (!leftUploading.value) {
        if (started.value) esm/* toast */.oR.warning(t("scanner.notify.warningSend"));
      ...
      (0,google/* setScanCan */.q)({
        ...
        if (res?.success && !scanClose) setTimeout(() => sendScannerBuffer(), 100);else if (res?.error) esm/* toast */.oR.error(res?.message);
      }).catch(() => esm/* toast */.oR.error(t("scanner.notify.errorSend"))).finally(() => {
        scanUploading = false;
      });
    };
...
/* harmony default export */ var DeviceInfoDialogvue_type_script_lang_ts = ({
  ...
  setup(props, context) {
    ...
    const showButtonTest = (0,runtime_core_esm_bundler/* computed */.EW)(() => store/* default */.A.getters["config/carModel"] !== mazda/* TCarModel */.oB.CAR_MODEL_MAZDA_CX9_REST);
  ...
  setup(props, {
    ...
    const onCarModelApplyClick = id => {
      ...
      if (store/* default */.A.getters["config/carModel"] !== id) {
        store/* default */.A.commit("config/setMazdaCarModel", id);
      }
    };
    return {
      visible,
...
const AboutDialog_exports_ = /*#__PURE__*/(0,exportHelper/* default */.A)(AboutDialogvue_type_script_lang_ts, [['render',render],['__scopeId',"data-v-7b4ac44c"]])
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return (0,runtime_core_esm_bundler/* openBlock */.uX)(), (0,runtime_core_esm_bundler/* createBlock */.Wv)(_component_dialog_template, {
    ...
    body: (0,runtime_core_esm_bundler/* withCtx */.k6)(() => [(0,runtime_core_esm_bundler/* createVNode */.bF)(VRow/* VRow */.L, {
      ...
      default: (0,runtime_core_esm_bundler/* withCtx */.k6)(() => [$setup.carModel !== $options.TCarModel.CAR_MODEL_MAZDA_CX7_REST && $setup.carModel !== $options.TCarModel.CAR_MODEL_MAZDA_CX9_REST ? ((0,runtime_core_esm_bundler/* openBlock */.uX)(), (0,runtime_core_esm_bundler/* createBlock */.Wv)(VCol/* VCol */.B, {
        key: 0,
        cols: "12",
        ...
        _: 1
      })) : (0,runtime_core_esm_bundler/* createCommentVNode */.Q3)("", true), $setup.carModel !== $options.TCarModel.CAR_MODEL_MAZDA_CX7_REST && $setup.carModel !== $options.TCarModel.CAR_MODEL_MAZDA_CX9_REST ? ((0,runtime_core_esm_bundler/* openBlock */.uX)(), (0,runtime_core_esm_bundler/* createBlock */.Wv)(VCol/* VCol */.B, {
        key: 1,
        cols: "12",
        class: "pb-0 d-flex justify-center"
      }, {
...
/* harmony default export */ var OnboardButtonsDialogvue_type_script_lang_ts = ({
  ...
  setup(props, {
    ...
    const send = (btn, press, timeout) => {
      const action = new mazda/* MazdaAction */.M_();
      action.btnType = btn;
...
const __exports__ = /*#__PURE__*/(0,exportHelper/* default */.A)(OnboardButtonsDialogvue_type_script_lang_ts, [['render',render],['__scopeId',"data-v-f54d1368"]])
...
var pjcan_version = __webpack_require__(55800);
// EXTERNAL MODULE: ./src/utils/time.ts
var time = __webpack_require__(22918);
...
/* harmony default export */ var UpdateFirmwareDialogvue_type_script_lang_ts = ({
  ...
  setup(props, {
    ...
    const onCompletingFirmware = () => {
      if (canbus/* default */.A.update.total > 0) {
        if (canbus/* default */.A.version.is) {
          canbus/* default */.A.checkVersion().then(() => esm/* toast */.oR.error(t("update.notify.warning"))).catch(() => esm/* toast */.oR.success(t("update.notify.completed")));
    ...
    const onErrorUpdate = msg => {
      esm/* toast */.oR.error(msg);
      onCancel();
    };
    (0,runtime_core_esm_bundler/* onMounted */.sV)(() => {
      canbus/* default */.A.addListener(pjcan_version/* API_VERSION_EVENT */.dD, onCompletingFirmware);
    ...
    (0,runtime_core_esm_bundler/* onUnmounted */.hi)(() => {
      canbus/* default */.A.removeListener(pjcan_version/* API_VERSION_EVENT */.dD, onCompletingFirmware);
